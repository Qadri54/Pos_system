            ...
            <div class="card shadow rounded-4 border-0" style="width: 22rem;">
                <div class="card-body d-flex flex-column gap-3">
                    ...
                    <div class="d-flex gap-2">
                        <button class="btn btn-success btn-sm mt-2" wire:click="updateStatus({{ $item['id'] }}, 'done')">
                            <i class="bi bi-check-circle"></i> Tandai Selesai
                        </button>
                        <button class="btn btn-danger btn-sm mt-2" wire:click="updateStatus({{ $item['id'] }}, 'canceled')">
